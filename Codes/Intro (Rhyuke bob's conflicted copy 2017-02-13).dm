	...
	Hollow_Story()
		if(!src.didityet)
			...
			if(src.key =="Abdulrahman_123")
				...
				src.defence+=6000
				src.reiatsu+=6000
			if(src.key=="The Oracle Child"||src.key=="246810daquarn")
				src.donorstat=267
				src.rawbuff+=40050
				src.mattack+=40050
				src.mdefence+=40050
			...
			if(src.key=="Sabakuryu"||src.key=="Natsu375")
				...
				src.defence+=60000
				src.reiatsu+=60000
			if(src.key=="WSHGC"||src.key=="Yugiman67")
				src.donorstat=80
				src.rawbuff+=12000
				src.mattack+=12000
				src.mdefence+=12000
			...
			if(src.key=="MatiasUchiha")
				...
				src.defence+=15000
				src.reiatsu+=15000
			if(src.key=="Kwilson3"||src.key=="Kwilson2"||src.key in specialverbs)
				src.donorstat=934
				src.rawbuff+=140000
				src.mattack+=140000
				src.mdefence+=140000
				src.mreiatsu+=140000
			if(src.key=="Crazieoreo"||src.key=="Awesome93")
				src.donorstat=367
				src.rawbuff+=55050
				src.mattack+=55050
				src.mdefence+=55050
				...
				src.defence+=55050
				src.reiatsu+=55050
			if(src.key=="Saikokira" || src.key=="Patriot10"||src.key=="Mambell")
				src.donorstat=80
				src.rawbuff+=12000
				src.mattack+=12000
				src.mdefence+=12000
			...
			if(src.key=="Dragonpearl123")
				...
				src.defence+=40050
				src.reiatsu+=40050
			if(src.key=="Mike oxsbig"||src.key=="Brook360")
				src.donorstat=334
				src.rawbuff+=50050
				src.mattack+=50050
				src.mdefence+=50050
			...
			if(src.key=="Lan0345"||src.key=="Jman8805" ||src.key == "LucasG2090" ||src.key=="XI BlowMe IX")
				...
				src.defence+=30000
				src.reiatsu+=30000
			if(src.key=="DredFTW"||src.key=="Marcobad12"||src.key=="Casim"|| src.key=="Nenkishi"||src.key=="SinZxPride"||src.key=="SinZxSloth"||src.key=="TheBlueReaper")
				src.donorstat=67
				src.rawbuff+=10050
				src.mattack+=10050
				src.mdefence+=10050
