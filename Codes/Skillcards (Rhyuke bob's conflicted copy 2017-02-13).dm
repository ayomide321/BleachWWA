...
var/screen_objects = newlist(/obj/hud/M1, /obj/hud/M2, /obj/hud/M3, /obj/hud/M4, /obj/hud/M5, /obj/hud/M6, /obj/hud/M7, /obj/hud/M8, /obj/hud/M9, /obj/hud/M0, /obj/hud/Msub, /obj/hud/Mequ)
		...
		Click()
			if(istype(usr,/mob/player))
				...
				if(src.names=="Acceleration Overdrive")
					if(usr.status=="Captain"||usr.status=="Captain Commander")
				...
				if(src.names=="Fire Ring")
					usr.Fire_Doll_Ring()
				if(src.names=="Heat Sounds/Aizen/'WAVE")
					usr.Heat_Sounds/Aizen/'WAVE()
				...
				if(src.names=="Cascada")
					usr.Cascada()
				if(src.names=="Sovereign Sounds/Aizen/'WAVE")
					usr.Sovereign_Sounds/Aizen/'WAVE()
				if(src.names=="Rev Up")
					usr.Rev_Up()
				if(src.names=="Poison")
					usr.Poison()
				...
				if(src.names=="Pills")
					usr.Pills()
				if(src.names=="Sounds/Aizen/'WAVE")
					usr.Sounds/Aizen/'WAVE()
				...
				if(src.names=="HollowRage")
					usr.HollowRage()
				if(src.names=="Water Sounds/Aizen/'WAVE")
					usr.Water_Sounds/Aizen/'WAVE()
				...
				if(src.names=="Infinity Ball")
					usr.DirectionBlast()
				if(src.names=="Death Sounds/Aizen/'WAVE")
					usr.DecaySounds/Aizen/'WAVE()
...
obj/skillcard
	...
	Sovereign_Sounds/Aizen/'WAVE
		names = "Sovereign Sounds/Aizen/'WAVE"
		icon = 'gui.dmi'
		icon_state = "sov Sounds/Aizen/'WAVE"
		layer = MOB_LAYER+100
		iszan=1
	Cascada
		names = "Cascada"
	...
	Heat_Sounds/Aizen/'WAVE
		names = "Heat Sounds/Aizen/'WAVE"
		icon = 'gui.dmi'
		icon_state = "Heat Sounds/Aizen/'WAVE"
		layer = MOB_LAYER+100
		iszan=1
	Reflect
		names = "Reflect"
	...
	WaterBolt
		...
		layer=MOB_LAYER+100
		iszan=1
	WaterSounds/Aizen/'WAVE
		names="Water Sounds/Aizen/'WAVE"
		icon='Icons/gui.dmi'
		icon_state="waterSounds/Aizen/'WAVE"
		layer=MOB_LAYER+100
		iszan=1
	WaterHeavens
	...
	Hyosuke_Stun
		...
		layer=MOB_LAYER+100
	Death_Sounds/Aizen/'WAVE
		names="Death Sounds/Aizen/'WAVE"
		icon='Icons/gui.dmi'
		icon_state="deathSounds/Aizen/'WAVE"
		layer=MOB_LAYER+100
	Infinity_Ball
		names="Infinity Ball"
		icon='Icons/gui.dmi'
